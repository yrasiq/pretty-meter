        ...
        <div className="card d-inline-flex">
          <div className="card-body">
            <ul>
              ...
              <li>Оценки приблизительные, мнение каждого человека может отличаться</li>
              <li className="text-danger">Возможны неточности и, порой, грубые ошибки. Убедительная просьба, не воспринимать результат всерьез и полагаться, в первую очередь, на свое мнение!</li>
            </ul>
          </div>
        </div>
      </div>
